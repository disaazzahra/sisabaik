...
- `daftar-penyedia.htm`' : formulir pendaftaran penyedia.
- `tawarkan-makanan.html` : formulir penawaran makanan berlebih. -`styles.css`: sistem visual dan layout responsif untuk seluruh halaman.
